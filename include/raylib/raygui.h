...
// TODO: Define additionally required macros for missing inputs 
    ...
    #define GUI_BUTTON_PRESSED      (IsMouseButtonReleased(MOUSE_LEFT_BUTTON) || IsGamepadButtonReleased(0, GAMEPAD_BUTTON_RIGHT_FACE_DOWN))
#endif
...
static float strtof(const char *text);         // Get float value from text
...
static float strtof(const char *text)
{
    float value = 0.0f;
    float sign = 1.0f;
